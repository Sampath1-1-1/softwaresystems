...
// Negative Integer (-1): If fork() fails, pid is -1, and you should handle this as an error.
        ...
        //1516 is process id of systemd which is init process.when child process executes getppid() which gives the pid of init process because parent process is dead.
    }
//nit is the traditional first process started by the Linux kernel when the system boots. 
